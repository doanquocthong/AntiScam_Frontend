...
**AntiScam** là ứng dụng Android giúp người dùng phát hiện, cảnh báo và chặn các **cuộc gọi hoặc tin nhắn lừa đảo**.  
Ứng dụng hoạt động như **ứng dụng gọi điện & nhắn tin mặc định**, đồng thời phân tích dữ liệu để cảnh báo người dùng theo **thời gian thực**.
